...
$GLOBALS['TCA']['tx_evchat_domain_model_administrator'] = array(
	'ctrl' => $GLOBALS['TCA']['tx_evchat_domain_model_administrator']['ctrl'],
	'interface' => array(
	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_evchat_domain_model_administrator.pid=###CURRENT_PID### AND tx_evchat_domain_model_administrator.sys_language_uid IN (-1,0)',
			),
		),
